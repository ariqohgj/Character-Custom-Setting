...
namespace EasyBuildSystem.Features.Runtime.Buildings.Placer
{
    ...
    public class BuildingPlacer : Singleton<BuildingPlacer>
    {
        ...
        void HandleFree()
        {
            ...
            {
                m_CurrentPreview.transform.position = MathExtension.Grid(m_CurrentPreview.GetPreviewSettings.MovementGridSize, m_CurrentPreview.GetPreviewSettings.MovementGridOffset,
                    lookDistance);
            }
        ...
        Vector3 GetLookPosition(Vector3 point)
        {
            ...
            Vector3 nextPoint = m_CurrentPreview.GetPreviewSettings.ClampPosition ?
            ...
            {
                nextPoint = Vector3.Lerp(m_CurrentPreview.transform.position, nextPoint, m_CurrentPreview.GetPreviewSettings.MovementSmoothTime * Time.deltaTime);
            }
            else if (m_CurrentPreview.GetPreviewSettings.Type == BuildingPart.PreviewSettings.MovementType.GRID)
            {
                nextPoint = MathExtension.Grid(m_CurrentPreview.GetPreviewSettings.MovementGridSize, m_CurrentPreview.GetPreviewSettings.MovementGridOffset, nextPoint);
            }
        ...
        {
            Vector3 lookDistance = m_RaycastSettings.GetCaster.position +
                m_RaycastSettings.GetCaster.forward * m_RaycastSettings.GetRaycastDistance;
