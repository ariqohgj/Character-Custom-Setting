            ...
            if (saveData != null)
            {
                ...
                for (int i = 0; i < saveData.Data.Count; i++)
                {
                    if (saveData.Data[i] != null)
                    {
                        ...
                        {
                            loadedBuildingParts.Add(BuildingManager.Instance.PlaceBuildingPart(buildingPart, saveData.Data[i].Position, saveData.Data[i].Rotation, saveData.Data[i].Scale));
